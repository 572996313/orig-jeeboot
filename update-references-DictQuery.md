...
| 文件 | 替换次数 |
|------|----------|
| `.\jeecg-module-system\jeecg-system-biz\src\main\java\org\jeecg\modules\system\controller\SysDictController.java` | 1 |
| `.\jeecg-module-system\jeecg-system-biz\src\main\java\org\jeecg\modules\system\mapper\SysDictMapper.java` | 1 |
| `.\jeecg-module-system\jeecg-system-biz\src\main\java\org\jeecg\modules\system\service\ISysDictService.java` | 1 |
...
# 3. 搜索是否还有旧包名引用
grep -r "org.jeecg.common.system.vo.DictQuery" --include="*.java" .
```
