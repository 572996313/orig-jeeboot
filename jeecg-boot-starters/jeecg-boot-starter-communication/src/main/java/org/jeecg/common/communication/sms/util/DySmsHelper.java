package org.jeecg.common.communication.sms.util;
...
import org.jeecg.common.communication.sms.config.JeecgSmsTemplateConfig;
import org.jeecg.config.StaticConfig; // 暂时保留，后续通过自动配置处理
import org.jeecg.common.util.SpringContextUtils; // 暂时保留，后续通过自动配置处理
